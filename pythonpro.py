...
path='C:\python\project\database'
print('-'*50)
...
def grade(num):
    if num>=90:
        ...
        return("Your performance is below average... Can be Improved... You have barely passed the exam with grade E.")
    else:
        return("Extremely poor performance... You Failed the Exam with grade F.")
...
def get_batch():
    with open(f'C:\python\project\database','r') as f:
        reader=csv.reader(f)
...
def remove(string):
    with open(f'C:\python\project\database','r+',newline='') as f:
        script=csv.reader(f)
...
def course_graph():
    ...
    with open(f'{path}/Course.csv','r')as f:
        ...
        lst=[['Python',(req[0].split('-'))[0:-1]],
             ...
             ['Mechanical Engineering',(req[3].split('-'))[0:-1]],
...
while message:
    ...
    with open(f'{path}/Course.csv','a',newline='')as f:
        ...
        script.writerow(['C004','Mechanical Engineering'])
...
for i in range(student_no):
    ...
    if duplicate('Student.csv',student_id,0):
        ...
        print()
        print("The subjects are [Python,Math,Physics,Mechanical Engineering,Biology,English]")
        print('please enter the subjects marks in the above mentioned order in a list type and if you dont have a particular subject write there "none" (e.g. [100,100,"none",75,69,85])')
        ...
        with open(f"{path}/ReportCards/{student_id}_{''.join(name.split())}.txt",'w') as f:
            ...
            f.writelines([f'Name of the student : {name} \n',
                          ...
                          f'Marks obtained in Mechanical Engineering is : {marks_lst[3]} \n',
